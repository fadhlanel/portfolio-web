...
const INITIAL_LETTERS: Omit<LetterData, 'posX' | 'posY' | 'wobble'>[] = [
  ...
  { id: 'a1', char: 'A', wordIdx: 0, letterIdx: 1 },
  { id: 'd1', char: 'D', wordIdx: 0, letterIdx: 2 },
  { id: 'h1', char: 'H', wordIdx: 0, letterIdx: 3 },
  { id: 'l1', char: 'L', wordIdx: 0, letterIdx: 4 },
  { id: 'a2', char: 'A', wordIdx: 0, letterIdx: 5 },
  { id: 'n2', char: 'N', wordIdx: 0, letterIdx: 6 },
  { id: 'e1', char: 'E', wordIdx: 1, letterIdx: 0 },
  { id: 'l2', char: 'L', wordIdx: 1, letterIdx: 1 },
];
