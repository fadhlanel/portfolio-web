                      ...
                      {profileData.contact.phone && (
                        <div className="sm:col-span-2 space-y-1">
                          <button
                            ...
                            className="w-full p-2 sm:p-2.5 rounded-xl sm:rounded-2xl bg-[#fffdf5] hover:bg-[#fde047] text-[#0f172a] font-mono font-bold text-[11px] sm:text-xs transition-all border-2 border-[#0f172a] shadow-[2px_2px_0px_#0f172a] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[1px_1px_0px_#0f172a] flex items-center justify-between cursor-pointer group"
                            title="Klik untuk salin nomor WhatsApp / telepon"
                          >
                            <div className="flex items-center gap-1.5">
                              <Phone className="w-3.5 h-3.5 text-[#16a34a]" />
                              <span>WhatsApp / Tel: {profileData.contact.phone}</span>
                            </div>
                            {copiedKey === 'phone' ? (
                          ...
                          {copiedKey === 'phone' && (
                            <div className="text-[10px] sm:text-xs font-mono font-bold text-[#15803d] flex items-center justify-center gap-1 animate-fadeIn pt-0.5">
