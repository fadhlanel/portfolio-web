...
> = {
  ...
  devops: {
    ...
    subtitle: 'Windows & Workflow',
    description:
      'Alur kerja pengembangan berbasis sistem operasi Windows, pengkodean di VS Code, otomasi script, dan manajemen kode dengan Git.',
    guarantees: [
      'Lingkungan kerja Windows OS',
      'Branching & version control Git',
      'Automasi script & terminal'
    ],
    role: 'Tools & Workflow'
  }
};
      ...
      >
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm sm:text-base text-[#1e293b] font-medium leading-relaxed bg-[#fff9d4]/60 p-4 rounded-2xl border border-[#0f172a]/20">
            Bidang keamanan siber yang sedang dipersiapkan mencakup Web Application Security (OWASP Top 10), Network Traffic Analysis, Capture The Flag (CTF), dan Application Security.
          </p>
        </div>
        ...
        <div className="space-y-3 pt-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div className="p-4 rounded-2xl bg-[#fff9d4] border-2 border-[#0f172a] shadow-[3px_3px_0px_#0f172a] space-y-1">
              ...
              <p className="text-xs text-[#475569] font-medium">
                Hardening izin sistem, keamanan file, dan isolasi proses.
              </p>
            </div>
          </div>
        </div>
